...
class Button extends StatelessWidget {
  ...
  Button({super.key, required this.color, required this.width, required this.height, required this.text, required this.press, required this.textWidth, required this.textColor});
